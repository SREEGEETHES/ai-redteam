...
class AgentAdapter:
    ...
    def get_baseline(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("agent_baseline_failed", error=str(e))
            return {"status_code": 0, "available_tools": [], "tool_calls": [], "execution_results": [], "headers": {}}
    ...
    def send_attack(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("agent_attack_failed", error=str(e))
    ...
    def test_unauthorized_tool(self) -> Dict[str, Any]:
        ...
        execution_blocked = result.get("status_code", 500) != 200 or "blocked" in str(result.get("execution_results", [])).lower()
