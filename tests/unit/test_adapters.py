...
from app.adapters.base import RESTAdapter, OllamaAdapter, OpenAICompatibleAdapter
...
class TestRESTAdapter:
    ...
    def test_adapter_creation_with_headers(self):
        adapter = RESTAdapter("http://localhost:8000", {"headers": {"Authorization": "Bearer token"}})
